...
const handleChange = (field,value)=>{
 onChange({...data,[field]:value})
  ...
  return (
    <div>
   <h3 className='text-lg font-semibold text-semibold text-gray-900'>Personal Information</h3>
   ...
   <div className='flex items-center gap-2'>
        <label>
            {data.image ? (
                ...
                <div className='inline-flex items-center gap-2 mt-5 text-slate-700 cursor-pointer'>
