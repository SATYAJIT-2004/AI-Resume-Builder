...
const TemplateSelector = ({selectedTemplate,onChange}) => {
    ...
    const templates = [
        {
            id:"classic",
            name:"Classic",
            preview:"A clean traditional resume format with clear sections and professionals"
        },{
           id:"modern",
            name:"Modern",
  ...
  return (
    <div className='relative'>
         <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-600 to-blur-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'>
            <Layout size={14}/>
