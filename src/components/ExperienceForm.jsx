          ...
          {data.map((experience, index) => (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
               ...
               <textarea value={experience.description || ""} onChange={(e)=>updateExperience(index,"description",e.target.value)} rows={4} className="w-full text-sm px-3 py-2 rounded-lg resize-none" placeholder="Describe your key responsibilities and achievents..."/>
                </div>
            </div>
          ))}
        </div>
