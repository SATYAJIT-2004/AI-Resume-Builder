...
const ColorPicker = ({selectedColor,onChange}) => {
 ...
 <button onClick={()=>setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-purple-600 bg-gradient-to-br from-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
