           ...
           <div className='grid lg:grid-cols-12 gap-8'>
                ...
                <div className='relative lg:col-span-5 rounded-lg'>
                  <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                    ...
                    <hr  className='absolute top-0 h-1 bg-gradient-to-r from-green-500 to-green-600 border-none transition-all duration-2000' style={{width:`${activeSectionIndex *100 / (sections.length - 1)}%`}}/>
                  {/* section navigation */}
                  <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                      <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1 gap-4'>
                  ...
                  <button onClick={()=>toast.promise(saveResume,{loading:'Saving...'})} className='bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 rng hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>Save changes</button>
                  </div>
                </div>
